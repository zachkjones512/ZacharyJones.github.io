  ...
  return (
    <>
      ...
      <div className='flex flex-col items-start w-full min-h-screen py-16 gap-4'>
        ...
        <Card Name={'North Texas Debate'} Title={'Student Web Assistant'} Body={body.unt}/>
        <Card Name={'Freelance'} Title={'Competitive Speech and Debate Consultant'} Body={body.debate}/>
        <Card Name={'Education'} Title={`University of North Texas · Bachelor's in Information Technology · Magna Cum Laude`} Body={body.edu}/>
      </div>
      <div className='flex flex-col items-start w-full min-h-screen py-16 gap-4'>
        <div className='w-full flex items-center py-2'>
      ...
      <div className='flex flex-col items-start w-full min-h-screen py-16 gap-4'>
        ...
        <Card Name={'Languages'} Title={'TypeScript · JavaScript · C# · C++ · Node · PHP · Java'} Body={""}/>
        <Card Name={'Technologies/Frameworks'} Title={'React · .NET · Git · MySQL · Windows · MacOS · GNU Linux · Jira · AWS · Visual Studio'} Body={""}/>
      ...
      <p>Interested in learning more? Find me on <a className='font-medium text-indigo-500 hover:text-indigo-400 transition-colors' target="_blank" href='https://www.linkedin.com/in/zachary-k-jones/'>LinkedIn</a></p>
    </>
  )
}
